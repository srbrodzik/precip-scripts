...
indir_base = '/home/disk/monsoon/precip/cfradial/spol_ncar/cfradial/rate/sur'
            ...
            for file in os.listdir(indir):
                if file.endswith('nc'):
                    ...
                    if cfTime >= start and cfTime <= end:
                        ...
                        cmd = bindir+'/make_spol_ppi_plots_uw_rrate.py3 '+indir+'/'+file+' '+outdir
                        os.system(cmd)
                    else:
