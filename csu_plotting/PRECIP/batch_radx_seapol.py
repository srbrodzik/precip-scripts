...
#	if len(outpath_file_check) == 0:
	if True:
		...
		os.system('mv %s/%s/%s %s/%s/%s'%(outpath, stripped_radxdate, radx_old_fname, outpath,stripped_radxdate, radx_new_fname))
