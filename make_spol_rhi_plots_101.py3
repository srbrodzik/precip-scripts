...
#fname = '/home/disk/monsoon/precip/cfradial/spol/20220531/cfrad.20220531_080000.424_to_20220531_080047.680_SPOL_PrecipRhi1_RHI.nc'
...
for index in range(0,len(angles)):
    ...
    if angle in desired_angles and angle == 101:
