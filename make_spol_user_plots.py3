...
if not os.path.isfile(outdir+'/'+file_out):
    ...
    display.plot('DBZ', sweep=0, ax=ax,
    ...
    display.plot('DBZ', sweep=2, ax=ax,
    ...
    display.plot('DBZ', sweep=4, ax=ax,
    ...
    display.plot('DBZ', sweep=6, ax=ax,
    ...
    display.plot('DBZ', sweep=8, ax=ax,
    ...
    display.plot('DBZ', sweep=10, ax=ax,
