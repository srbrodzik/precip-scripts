...
indir_base = '/home/disk/monsoon/precip/cfradial/spol_ncar/cfradial/spoldrx/sur'
...
start = datetime(2022,5,30,0,0,0)
end = datetime(2022,5,31,0,0,0)
                ...
                if file.endswith('nc'):
                    ...
                    if cfTime >= start and cfTime <= end:
                        ...
                        if 'Sur1' in file or 'Sur2' in file:
                            ...
                            cmd = bindir+'/make_spol_ppi_plots_uw.py3 '+indir+'/'+file+' '+outdir
                            os.system(cmd)
                        else:
