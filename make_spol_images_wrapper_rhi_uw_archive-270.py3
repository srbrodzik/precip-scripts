...
indir_base = '/home/disk/monsoon/precip/cfradial/spol_ncar/cfradial/spoldrx/rhi'
...
start = datetime(2022,5,25,0,0,0)
end = datetime(2022,6,1,0,0,0)
            ...
            for file in os.listdir(indir):
                ...
                if cfTime >= start and cfTime <= end:
                    ...
                    if 'Rhi1' in file or 'Rhi2' in file:
                        ...
                        cmd = bindir+'/make_spol_rhi_plots_uw-270.py3 '+indir+'/'+file+' '+outdir
                        os.system(cmd)
                    elif 'User' in file:
                        outdir = outdir_base+'/rhi'
                        cmd = bindir+'/make_spol_user_plots_uw.py3 '+indir+'/'+file+' '+outdir
                        os.system(cmd)
                    else:
